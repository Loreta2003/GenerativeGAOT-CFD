...
def plot_learning_rate(lr_log, 
                       save_path=None):
    """
    Plots the learning rate over time from a log file.

    Parameters
    ----------
    lr_log : str
        learning rate log file.
    ...
    -------
    fig : plt.Figure
        The figure containing the learning rate plot.
    """

    steps, lr = zip(*lr_log)

    fig, ax = plt.subplots(figsize=(10, 6))
    ax.plot(steps, lr, marker='o', linestyle='-', color='b')
